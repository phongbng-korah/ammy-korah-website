# Thông số kỹ thuật 6 model KORAH — Bảng tra cứu nhanh

> Nguồn: `support.html` — mục "Tra cứu nhanh". Số liệu đối chiếu chuẩn theo datasheet PDF từng model (`assets/manuals/datasheet-<model>-16x9.pdf` / `-9x16.pdf`).
